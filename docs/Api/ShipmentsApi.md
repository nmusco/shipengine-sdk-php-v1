...
> \Nmusco\ShipEngine\v1\Model\CreateShipmentsResponseBody createShipments($create_shipments_request_body)
...
$create_shipments_request_body = new \Nmusco\ShipEngine\v1\Model\CreateShipmentsRequestBody(); // \Nmusco\ShipEngine\v1\Model\CreateShipmentsRequestBody | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **create_shipments_request_body** | [**\Nmusco\ShipEngine\v1\Model\CreateShipmentsRequestBody**](../Model/CreateShipmentsRequestBody.md)|  |

### Return type

[**\Nmusco\ShipEngine\v1\Model\CreateShipmentsResponseBody**](../Model/CreateShipmentsResponseBody.md)
...
> \Nmusco\ShipEngine\v1\Model\GetShipmentByExternalIdResponseBody getShipmentByExternalId($external_shipment_id)
...
[**\Nmusco\ShipEngine\v1\Model\GetShipmentByExternalIdResponseBody**](../Model/GetShipmentByExternalIdResponseBody.md)
...
> \Nmusco\ShipEngine\v1\Model\GetShipmentByIdResponseBody getShipmentById($shipment_id)
...
[**\Nmusco\ShipEngine\v1\Model\GetShipmentByIdResponseBody**](../Model/GetShipmentByIdResponseBody.md)
...
> \Nmusco\ShipEngine\v1\Model\ListShipmentErrorsResponseBody listShipmentErrors($shipment_id, $page, $pagesize)
...
[**\Nmusco\ShipEngine\v1\Model\ListShipmentErrorsResponseBody**](../Model/ListShipmentErrorsResponseBody.md)
...
> \Nmusco\ShipEngine\v1\Model\ListShipmentRatesResponseBody listShipmentRates($shipment_id, $created_at_start)
...
[**\Nmusco\ShipEngine\v1\Model\ListShipmentRatesResponseBody**](../Model/ListShipmentRatesResponseBody.md)
...
> \Nmusco\ShipEngine\v1\Model\ListShipmentsResponseBody listShipments($shipment_status, $batch_id, $tag, $created_at_start, $created_at_end, $modified_at_start, $modified_at_end, $page, $page_size, $sales_order_id, $sort_dir, $sort_by)
...
$shipment_status = new \Nmusco\ShipEngine\v1\Model\\Nmusco\ShipEngine\v1\Model\ShipmentStatus(); // \Nmusco\ShipEngine\v1\Model\ShipmentStatus | 
...
$sort_by = modified_at; // \Nmusco\ShipEngine\v1\Model\ShipmentsSortBy | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **shipment_status** | [**\Nmusco\ShipEngine\v1\Model\ShipmentStatus**](../Model/.md)|  | [optional]
 ...
 **sort_by** | [**\Nmusco\ShipEngine\v1\Model\ShipmentsSortBy**](../Model/.md)|  | [optional]

### Return type

[**\Nmusco\ShipEngine\v1\Model\ListShipmentsResponseBody**](../Model/ListShipmentsResponseBody.md)
...
> \Nmusco\ShipEngine\v1\Model\ParseShipmentResponseBody parseShipment($parse_shipment_request_body)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parse_shipment_request_body** | [**\Nmusco\ShipEngine\v1\Model\ParseShipmentRequestBody**](../Model/ParseShipmentRequestBody.md)| The only required field is &#x60;text&#x60;, which is the text to be parsed. You can optionally also provide a &#x60;shipment&#x60; containing any already-known values. For example, you probably already know the &#x60;ship_from&#x60; address, and you may also already know what carrier and service you want to use. |

### Return type

[**\Nmusco\ShipEngine\v1\Model\ParseShipmentResponseBody**](../Model/ParseShipmentResponseBody.md)
...
> \Nmusco\ShipEngine\v1\Model\TagShipmentResponseBody tagShipment($shipment_id, $tag_name)
...
[**\Nmusco\ShipEngine\v1\Model\TagShipmentResponseBody**](../Model/TagShipmentResponseBody.md)
...
> \Nmusco\ShipEngine\v1\Model\UpdateShipmentResponseBody updateShipment($shipment_id, $update_shipment_request_body)
...
$shipment_id = 'shipment_id_example'; // string | Shipment ID
$update_shipment_request_body = new \Nmusco\ShipEngine\v1\Model\UpdateShipmentRequestBody(); // \Nmusco\ShipEngine\v1\Model\UpdateShipmentRequestBody | 
...
------------- | ------------- | ------------- | -------------
 **shipment_id** | **string**| Shipment ID |
 **update_shipment_request_body** | [**\Nmusco\ShipEngine\v1\Model\UpdateShipmentRequestBody**](../Model/UpdateShipmentRequestBody.md)|  |

### Return type

[**\Nmusco\ShipEngine\v1\Model\UpdateShipmentResponseBody**](../Model/UpdateShipmentResponseBody.md)
