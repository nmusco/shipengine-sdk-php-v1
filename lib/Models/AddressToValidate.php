...
/**
 * AddressToValidate Class Doc Comment
 *
 * @category Class
 ...
 */
class AddressToValidate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'address_to_validate';
    ...
    public function setAddressLine1($address_line1)
    {
        ...
        if ((mb_strlen($address_line1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling AddressToValidate., must be bigger than or equal to 1.');
        }
    ...
    public function setCityLocality($city_locality)
    {
        ...
        if ((mb_strlen($city_locality) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city_locality when calling AddressToValidate., must be bigger than or equal to 1.');
        }
    ...
    public function setStateProvince($state_province)
    {
        ...
        if ((mb_strlen($state_province) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state_province when calling AddressToValidate., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AddressToValidate., must be bigger than or equal to 1.');
        }
