 ...
 *
 * @category Class
 * @description The information necessary to ship a package, such as the origin, the destination, the carrier service, and the package dimensions and weight.  &gt; **Note:** Either &#x60;ship_from&#x60; or &#x60;warehouse_id&#x60; must be set.
 * @package  Nmusco\ShipEngine\v1
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Shipment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setExternalShipmentId($external_shipment_id)
    {
        if (!is_null($external_shipment_id) && (mb_strlen($external_shipment_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $external_shipment_id when calling Shipment., must be smaller than or equal to 50.');
        }
