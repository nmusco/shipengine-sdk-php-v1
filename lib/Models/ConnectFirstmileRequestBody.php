...
/**
 * ConnectFirstmileRequestBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ConnectFirstmileRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_firstmile_request_body';
    ...
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ConnectFirstmileRequestBody., must be bigger than or equal to 1.');
        }
     ...
     * Sets mailer_id
     *
     * @param string $mailer_id A string that uniquely identifies the mailer
     *
     * @return self
     */
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling ConnectFirstmileRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setProfileName($profile_name)
    {
        ...
        if (!is_null($profile_name) && (mb_strlen($profile_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $profile_name when calling ConnectFirstmileRequestBody., must be bigger than or equal to 1.');
        }
