 ...
 *
 * @category Class
 * @description Any residential or business mailing address, anywhere in the world.  &gt; **Note:** Either &#x60;name&#x60; or &#x60;company_name&#x60; must be set. Both may be specified, if relevant.
 * @package  Nmusco\ShipEngine\v1
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['city_locality']) < 1)) {
        ...
        if ((mb_strlen($this->container['state_province']) < 1)) {
        ...
        if ($this->container['address_residential_indicator'] === null) {
            $invalidProperties[] = "'address_residential_indicator' can't be null";
        }
     ...
     * Sets name
     *
     * @param string $name The name of a contact person at this address.  This field may be set instead of - or in addition to - the `company_name` field.
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string $phone The phone number of a contact person at this address.  The format of this phone number varies depending on the country.
     *
     * @return self
     */
     ...
     * Sets address_line1
     *
     * @param string $address_line1 The first line of the street address.  For some addresses, this may be the only line.  Other addresses may require 2 or 3 lines.
     *
     * @return self
     */
     ...
     * Sets city_locality
     *
     * @param string $city_locality The name of the city or locality
     *
     * @return self
     */
    public function setCityLocality($city_locality)
    {
        ...
        if ((mb_strlen($city_locality) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city_locality when calling Address., must be bigger than or equal to 1.');
        }
     ...
     * Sets state_province
     *
     * @param string $state_province The state or province.  For some countries (including the U.S.) only abbreviations are allowed.  Other countries allow the full name or abbreviation.
     *
     * @return self
     */
    public function setStateProvince($state_province)
    {
        ...
        if ((mb_strlen($state_province) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state_province when calling Address., must be bigger than or equal to 1.');
        }
     ...
     * Sets country_code
     *
     * @param string $country_code The two-letter [ISO 3166-1 country code](https://en.wikipedia.org/wiki/ISO_3166-1)
     *
     * @return self
     */
     ...
     *
     * @param AddressResidentialIndicator $address_residential_indicator Indicates whether this is a residential address.
     *
     * @return self
     */
