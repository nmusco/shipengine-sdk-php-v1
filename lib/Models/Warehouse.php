...
class Warehouse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets name
     *
     * @param string|null $name Name of the warehouse
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Warehouse., must be bigger than or equal to 1.');
        }
     ...
     * Sets origin_address
     *
     * @param Address|null $origin_address The origin address of the warehouse
     *
     * @return self
     */
