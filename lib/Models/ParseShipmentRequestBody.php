...
/**
 * ParseShipmentRequestBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ParseShipmentRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'parse_shipment_request_body';
     ...
     * Sets text
     *
     * @param string $text The unstructured text that contains shipping-related entities
     *
     * @return self
     */
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling ParseShipmentRequestBody., must be bigger than or equal to 1.');
        }
     ...
     * Sets shipment
     *
     * @param PartialShipment|null $shipment You can optionally provide a `shipment` object containing any already-known values. For example, you probably already know the `ship_from` address, and you may also already know what carrier and service you want to use.
     *
     * @return self
     */
