...
/**
 * ConnectPurolatorRequestBody Class Doc Comment
 *
 * @category Class
 ...
 */
class ConnectPurolatorRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_purolator_request_body';
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling ConnectPurolatorRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setActivationKey($activation_key)
    {
        ...
        if ((mb_strlen($activation_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $activation_key when calling ConnectPurolatorRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ConnectPurolatorRequestBody., must be bigger than or equal to 1.');
        }
