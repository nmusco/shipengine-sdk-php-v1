 ...
 * @link     https://openapi-generator.tech
 */
class RateEstimateOptions implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['from_country_code'] = isset($data['from_country_code']) ? $data['from_country_code'] : null;
        $this->container['from_postal_code'] = isset($data['from_postal_code']) ? $data['from_postal_code'] : null;
        $this->container['from_city_locality'] = isset($data['from_city_locality']) ? $data['from_city_locality'] : null;
        $this->container['from_state_province'] = isset($data['from_state_province']) ? $data['from_state_province'] : null;
        $this->container['to_country_code'] = isset($data['to_country_code']) ? $data['to_country_code'] : null;
        $this->container['to_postal_code'] = isset($data['to_postal_code']) ? $data['to_postal_code'] : null;
        $this->container['to_city_locality'] = isset($data['to_city_locality']) ? $data['to_city_locality'] : null;
        $this->container['to_state_province'] = isset($data['to_state_province']) ? $data['to_state_province'] : null;
        $this->container['weight'] = isset($data['weight']) ? $data['weight'] : null;
        $this->container['dimensions'] = isset($data['dimensions']) ? $data['dimensions'] : null;
        $this->container['confirmation'] = isset($data['confirmation']) ? $data['confirmation'] : null;
        $this->container['address_residential_indicator'] = isset($data['address_residential_indicator']) ? $data['address_residential_indicator'] : null;
