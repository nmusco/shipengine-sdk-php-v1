...
/**
 * ConnectEndiciaRequestBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ConnectEndiciaRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_endicia_request_body';
    ...
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ConnectEndiciaRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setAccount($account)
    {
        ...
        if ((mb_strlen($account) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account when calling ConnectEndiciaRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setPassphrase($passphrase)
    {
        ...
        if ((mb_strlen($passphrase) < 1)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling ConnectEndiciaRequestBody., must be bigger than or equal to 1.');
        }
