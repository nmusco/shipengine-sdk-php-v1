...
/**
 * ShipmentResponseError Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ShipmentResponseError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_response_error';
     ...
     * Sets error
     *
     * @param string $error Shipment error message
     *
     * @return self
     */
    public function setError($error)
    {
        ...
        if ((mb_strlen($error) < 1)) {
            throw new \InvalidArgumentException('invalid length for $error when calling ShipmentResponseError., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $external_shipment_id A string that uniquely identifies the external shipment.
     *
     * @return self
     */
