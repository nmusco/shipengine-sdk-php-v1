...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.shipengine.com';
     ...
     * @var string
     */
    protected $userAgent = 'nmusco/shipengine-sdk-php-v1';
    ...
    {
        $report  = 'PHP SDK (Nmusco\ShipEngine\v1) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.1.202012161912' . PHP_EOL;
        $report .= '    SDK Package Version: 1.1.202012041812.1' . PHP_EOL;
