...
class Weight implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets value
     *
     * @param double $value The weight, in the specified unit
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if (($value <= 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling Weight., must be bigger than 0.');
        }
