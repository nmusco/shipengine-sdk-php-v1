...
/**
 * ConnectAustraliaPostRequestBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ConnectAustraliaPostRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_australia_post_request_body';
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling ConnectAustraliaPostRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling ConnectAustraliaPostRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setApiSecret($api_secret)
    {
        ...
        if ((mb_strlen($api_secret) < 1)) {
            throw new \InvalidArgumentException('invalid length for $api_secret when calling ConnectAustraliaPostRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ConnectAustraliaPostRequestBody., must be bigger than or equal to 1.');
        }
