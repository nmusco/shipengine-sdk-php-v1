...
/**
 * GetPackageTypeByIdResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class GetPackageTypeByIdResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_package_type_by_id_response_body';
     ...
     * Sets package_code
     *
     * @param string $package_code package_code
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetPackageTypeByIdResponseBody., must be bigger than or equal to 1.');
        }
     ...
     * Sets package_id
     *
     * @param string|null $package_id A string that uniquely identifies the package.
     *
     * @return self
     */
     ...
     * Sets dimensions
     *
     * @param Dimensions|null $dimensions The custom dimensions for the package.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Provides a helpful description for the custom package.
     *
     * @return self
     */
