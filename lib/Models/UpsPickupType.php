...
/**
 * UpsPickupType Class Doc Comment
 *
 * @category Class
...
class UpsPickupType
{
     ...
     */
    const DAILY_PICKUP = 'daily_pickup';
    const OCCASIONAL_PICKUP = 'occasional_pickup';
    const CUSTOMER_COUNTER = 'customer_counter';
