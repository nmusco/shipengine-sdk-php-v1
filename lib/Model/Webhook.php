...
class Webhook implements ModelInterface, ArrayAccess
{
     ...
     * Sets webhook_id
     *
     * @param string|null $webhook_id A string that uniquely identifies the webhook
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string|null $url The url that the webhook sends the request to
     *
     * @return $this
     */
     ...
     * Sets event
     *
     * @param WebhookEvent|null $event event
     *
     * @return $this
     */
