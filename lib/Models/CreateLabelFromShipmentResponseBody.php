...
/**
 * CreateLabelFromShipmentResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateLabelFromShipmentResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_label_from_shipment_response_body';
    ...
    public function setTrackingNumber($tracking_number)
    {
        ...
        if (!is_null($tracking_number) && (mb_strlen($tracking_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling CreateLabelFromShipmentResponseBody., must be bigger than or equal to 1.');
        }
