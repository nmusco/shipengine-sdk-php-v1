...
/**
 * CreateManifestRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Nmusco\ShipEngine\v1
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CreateManifestRequestBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_manifest_request_body';
     ...
     * Sets label_ids
     *
     * @param string[] $label_ids The list of label ids to include in the manifest
     *
     * @return $this
     */
