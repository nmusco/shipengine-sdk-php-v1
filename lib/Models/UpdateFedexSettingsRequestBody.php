...
/**
 * UpdateFedexSettingsRequestBody Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateFedexSettingsRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_fedex_settings_request_body';
    ...
    public function setNickname($nickname)
    {
        ...
        if (!is_null($nickname) && (mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling UpdateFedexSettingsRequestBody., must be bigger than or equal to 1.');
        }
