...
/**
 * ConnectInsurerRequestBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ConnectInsurerRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_insurer_request_body';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['policy_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'policy_id', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setPolicyId($policy_id)
    {
        ...
        if ((mb_strlen($policy_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $policy_id when calling ConnectInsurerRequestBody., must be bigger than or equal to 1.');
        }
