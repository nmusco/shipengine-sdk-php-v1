...
/**
 * ConnectOntracRequestBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ConnectOntracRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_ontrac_request_body';
    ...
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ConnectOntracRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling ConnectOntracRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling ConnectOntracRequestBody., must be bigger than or equal to 1.');
        }
