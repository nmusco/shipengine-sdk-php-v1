 ...
 * @link     https://openapi-generator.tech
 */
class PackageType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'package_type';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PackageType., must be bigger than or equal to 1.');
        }
