...
/**
 * UpdateShipmentResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateShipmentResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_shipment_response_body';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['address_validation'] = $data['address_validation'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['address_validation'] === null) {
            $invalidProperties[] = "'address_validation' can't be null";
        }
     ...
     * Sets errors
     *
     * @param string[] $errors An array of errors that occurred while creating shipment.
     *
     * @return self
     */
     ...
     *
     * @param AddressValidationResult $address_validation The address validation
     *
     * @return self
     */
    ...
    public function setExternalShipmentId($external_shipment_id)
    {
        if (!is_null($external_shipment_id) && (mb_strlen($external_shipment_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $external_shipment_id when calling UpdateShipmentResponseBody., must be smaller than or equal to 50.');
        }
