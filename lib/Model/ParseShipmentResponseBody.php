...
/**
 * ParseShipmentResponseBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ParseShipmentResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'parse_shipment_response_body';
    ...
    public function setScore($score)
    {
        ...
        if (($score > 1)) {
            throw new \InvalidArgumentException('invalid value for $score when calling ParseShipmentResponseBody., must be smaller than or equal to 1.');
        }
        if (($score < 0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling ParseShipmentResponseBody., must be bigger than or equal to 0.');
        }
     ...
     * Sets entities
     *
     * @param \Nmusco\ShipEngine\v1\Model\RecognizedEntity[] $entities All of the entities that were recognized in the text. An \"entity\" is a single piece of data, such as a city, a postal code, a carrier name, or a package weight.  Each entity includes the original text and the parsed value.
     *
     * @return $this
     */
