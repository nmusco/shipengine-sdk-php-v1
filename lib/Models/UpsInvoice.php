 ...
 */
class UpsInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ups_invoice';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['control_id'] = $data['control_id'] ?? null;
        $this->container['invoice_amount'] = $data['invoice_amount'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['invoice_amount']) && ($this->container['invoice_amount'] < 0)) {
            $invalidProperties[] = "invalid value for 'invoice_amount', must be bigger than or equal to 0.";
        }
    ...
    public function setInvoiceNumber($invoice_number)
    {
        ...
        if (!is_null($invoice_number) && (mb_strlen($invoice_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $invoice_number when calling UpsInvoice., must be bigger than or equal to 1.');
        }
     ...
     * Sets control_id
     *
     * @param string|null $control_id A string that uniquely identifies the control
     *
     * @return self
     */
     ...
     * Sets invoice_amount
     *
     * @param double|null $invoice_amount invoice_amount
     *
     * @return self
     */
    public function setInvoiceAmount($invoice_amount)
    {
        ...
        if (!is_null($invoice_amount) && ($invoice_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $invoice_amount when calling UpsInvoice., must be bigger than or equal to 0.');
        }
