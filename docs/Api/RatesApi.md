...
> \Nmusco\ShipEngine\v1\Model\CalculateRatesResponseBody calculateRates($calculate_rates_request_body)
...
$calculate_rates_request_body = new \Nmusco\ShipEngine\v1\Model\CalculateRatesRequestBody(); // \Nmusco\ShipEngine\v1\Model\CalculateRatesRequestBody | 
...
------------- | ------------- | ------------- | -------------
 **calculate_rates_request_body** | [**\Nmusco\ShipEngine\v1\Model\CalculateRatesRequestBody**](../Model/CalculateRatesRequestBody.md)|  |

### Return type

[**\Nmusco\ShipEngine\v1\Model\CalculateRatesResponseBody**](../Model/CalculateRatesResponseBody.md)
...
> \Nmusco\ShipEngine\v1\Model\BulkRate[] compareBulkRates($compare_bulk_rates_request_body)
...
$compare_bulk_rates_request_body = new \Nmusco\ShipEngine\v1\Model\CompareBulkRatesRequestBody(); // \Nmusco\ShipEngine\v1\Model\CompareBulkRatesRequestBody | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **compare_bulk_rates_request_body** | [**\Nmusco\ShipEngine\v1\Model\CompareBulkRatesRequestBody**](../Model/CompareBulkRatesRequestBody.md)|  |

### Return type

[**\Nmusco\ShipEngine\v1\Model\BulkRate[]**](../Model/BulkRate.md)
...
$estimate_rates_request_body = new \Nmusco\ShipEngine\v1\Model\EstimateRatesRequestBody(); // \Nmusco\ShipEngine\v1\Model\EstimateRatesRequestBody | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **estimate_rates_request_body** | [**\Nmusco\ShipEngine\v1\Model\EstimateRatesRequestBody**](../Model/EstimateRatesRequestBody.md)|  |
...
> \Nmusco\ShipEngine\v1\Model\GetRateByIdResponseBody getRateById($rate_id)
...
[**\Nmusco\ShipEngine\v1\Model\GetRateByIdResponseBody**](../Model/GetRateByIdResponseBody.md)
