 ...
 * @link     https://openapi-generator.tech
 */
class RateEstimate implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['confirmation_amount'] = isset($data['confirmation_amount']) ? $data['confirmation_amount'] : null;
        ...
        $this->container['guaranteed_service'] = isset($data['guaranteed_service']) ? $data['guaranteed_service'] : null;
        $this->container['estimated_delivery_date'] = isset($data['estimated_delivery_date']) ? $data['estimated_delivery_date'] : null;
        $this->container['carrier_delivery_days'] = isset($data['carrier_delivery_days']) ? $data['carrier_delivery_days'] : null;
        $this->container['ship_date'] = isset($data['ship_date']) ? $data['ship_date'] : null;
        $this->container['negotiated_rate'] = isset($data['negotiated_rate']) ? $data['negotiated_rate'] : null;
        ...
        $this->container['carrier_nickname'] = isset($data['carrier_nickname']) ? $data['carrier_nickname'] : null;
        $this->container['carrier_friendly_name'] = isset($data['carrier_friendly_name']) ? $data['carrier_friendly_name'] : null;
