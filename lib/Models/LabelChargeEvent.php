...
/**
 * LabelChargeEvent Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class LabelChargeEvent
{
    /**
     * Possible values of this enum
     */
    const CARRIER_DEFAULT = 'carrier_default';
    const ON_CREATION = 'on_creation';
    const ON_CARRIER_ACCEPTANCE = 'on_carrier_acceptance';
    ...
    {
        return [
            self::CARRIER_DEFAULT,
            self::ON_CREATION,
            self::ON_CARRIER_ACCEPTANCE,
        ];
    }
}
