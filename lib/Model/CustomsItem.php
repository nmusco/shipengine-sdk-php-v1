...
class CustomsItem implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['customs_item_id'] = isset($data['customs_item_id']) ? $data['customs_item_id'] : null;
        $this->container['description'] = isset($data['description']) ? $data['description'] : 'null';
        $this->container['quantity'] = isset($data['quantity']) ? $data['quantity'] : 0;
        $this->container['value'] = isset($data['value']) ? $data['value'] : null;
        $this->container['harmonized_tariff_code'] = isset($data['harmonized_tariff_code']) ? $data['harmonized_tariff_code'] : 'null';
