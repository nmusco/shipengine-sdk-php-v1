...
class Label implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'packages' => '\Nmusco\ShipEngine\v1\Model\Package[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['shipment_cost'] = isset($data['shipment_cost']) ? $data['shipment_cost'] : null;
        $this->container['insurance_cost'] = isset($data['insurance_cost']) ? $data['insurance_cost'] : null;
        $this->container['tracking_number'] = isset($data['tracking_number']) ? $data['tracking_number'] : null;
        $this->container['is_return_label'] = isset($data['is_return_label']) ? $data['is_return_label'] : null;
        ...
        $this->container['charge_event'] = isset($data['charge_event']) ? $data['charge_event'] : null;
        $this->container['outbound_label_id'] = isset($data['outbound_label_id']) ? $data['outbound_label_id'] : null;
        $this->container['service_code'] = isset($data['service_code']) ? $data['service_code'] : null;
        $this->container['test_label'] = isset($data['test_label']) ? $data['test_label'] : false;
        $this->container['package_code'] = isset($data['package_code']) ? $data['package_code'] : null;
        $this->container['validate_address'] = isset($data['validate_address']) ? $data['validate_address'] : null;
        ...
        $this->container['label_download_type'] = isset($data['label_download_type']) ? $data['label_download_type'] : null;
        $this->container['label_format'] = isset($data['label_format']) ? $data['label_format'] : null;
        $this->container['display_scheme'] = isset($data['display_scheme']) ? $data['display_scheme'] : null;
        ...
        $this->container['label_image_id'] = isset($data['label_image_id']) ? $data['label_image_id'] : null;
        ...
        $this->container['label_download'] = isset($data['label_download']) ? $data['label_download'] : null;
        $this->container['form_download'] = isset($data['form_download']) ? $data['form_download'] : null;
        $this->container['insurance_claim'] = isset($data['insurance_claim']) ? $data['insurance_claim'] : null;
     ...
     * Gets packages
     *
     * @return \Nmusco\ShipEngine\v1\Model\Package[]|null
     */
     ...
     * Sets packages
     *
     * @param \Nmusco\ShipEngine\v1\Model\Package[]|null $packages The label's package(s).  > **Note:** Some carriers only allow one package per label.  If you attempt to create a multi-package label for a carrier that doesn't allow it, an error will be returned.
     *
     * @return $this
     */
