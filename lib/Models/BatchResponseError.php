...
/**
 * BatchResponseError Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class BatchResponseError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'batch_response_error';
     ...
     * Sets error
     *
     * @param string|null $error Error message associated with the shipment.
     *
     * @return self
     */
    public function setError($error)
    {
        ...
        if (!is_null($error) && (mb_strlen($error) < 1)) {
            throw new \InvalidArgumentException('invalid length for $error when calling BatchResponseError., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $external_shipment_id An external shipment id associated with the shipment
     *
     * @return self
     */
