...
/**
 * GetCarriersResponseBody Class Doc Comment
 *
 * @category Class
 * @package  Nmusco\ShipEngine\v1
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetCarriersResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_carriers_response_body';
     ...
     * Sets carriers
     *
     * @param Carrier[] $carriers The carrier response body
     *
     * @return self
     */
     ...
     * Sets request_id
     *
     * @param string $request_id A UUID that uniquely identifies the request id. This can be given to the support team to help debug non-trivial issues that may occur
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param Error[] $errors The errors associated with the failed API call
     *
     * @return self
     */
