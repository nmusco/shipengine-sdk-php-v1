...
/**
 * GetRateByIdResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class GetRateByIdResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_rate_by_id_response_body';
    ...
    public function setZone($zone)
    {
        ...
        if (($zone < 0)) {
            throw new \InvalidArgumentException('invalid value for $zone when calling GetRateByIdResponseBody., must be bigger than or equal to 0.');
        }
    ...
    public function setPackageType($package_type)
    {
        ...
        if ((mb_strlen($package_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $package_type when calling GetRateByIdResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setServiceType($service_type)
    {
        ...
        if ((mb_strlen($service_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $service_type when calling GetRateByIdResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setServiceCode($service_code)
    {
        ...
        if ((mb_strlen($service_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $service_code when calling GetRateByIdResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setCarrierCode($carrier_code)
    {
        ...
        if ((mb_strlen($carrier_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $carrier_code when calling GetRateByIdResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setCarrierNickname($carrier_nickname)
    {
        ...
        if ((mb_strlen($carrier_nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $carrier_nickname when calling GetRateByIdResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setCarrierFriendlyName($carrier_friendly_name)
    {
        ...
        if ((mb_strlen($carrier_friendly_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $carrier_friendly_name when calling GetRateByIdResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setDeliveryDays($delivery_days)
    {
        ...
        if (!is_null($delivery_days) && ($delivery_days < 1)) {
            throw new \InvalidArgumentException('invalid value for $delivery_days when calling GetRateByIdResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setCarrierDeliveryDays($carrier_delivery_days)
    {
        ...
        if (!is_null($carrier_delivery_days) && (mb_strlen($carrier_delivery_days) < 1)) {
            throw new \InvalidArgumentException('invalid length for $carrier_delivery_days when calling GetRateByIdResponseBody., must be bigger than or equal to 1.');
        }
