...
/**
 * GetManifestByIdResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class GetManifestByIdResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_manifest_by_id_response_body';
    ...
    public function setShipments($shipments)
    {
        ...
        if (($shipments < 1)) {
            throw new \InvalidArgumentException('invalid value for $shipments when calling GetManifestByIdResponseBody., must be bigger than or equal to 1.');
        }
     ...
     * Sets label_ids
     *
     * @param string[] $label_ids An array of the label ids used in this manifest.
     *
     * @return self
     */
    ...
    public function setSubmissionId($submission_id)
    {
        ...
        if ((mb_strlen($submission_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $submission_id when calling GetManifestByIdResponseBody., must be bigger than or equal to 1.');
        }
