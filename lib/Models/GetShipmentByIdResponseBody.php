...
/**
 * GetShipmentByIdResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class GetShipmentByIdResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_shipment_by_id_response_body';
    ...
    public function setExternalShipmentId($external_shipment_id)
    {
        if (!is_null($external_shipment_id) && (mb_strlen($external_shipment_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $external_shipment_id when calling GetShipmentByIdResponseBody., must be smaller than or equal to 50.');
        }
