...
/**
 * UpdateWarehouseRequestBody Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateWarehouseRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_warehouse_request_body';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateWarehouseRequestBody., must be bigger than or equal to 1.');
        }
