...
/**
 * ConnectAsendiaRequestBody Class Doc Comment
 *
 * @category Class
 ...
 */
class ConnectAsendiaRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_asendia_request_body';
     ...
     * Sets nickname
     *
     * @param string $nickname The nickname of the Asendia account
     *
     * @return self
     */
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ConnectAsendiaRequestBody., must be bigger than or equal to 1.');
        }
     ...
     * Sets account_number
     *
     * @param string $account_number Asendia account number
     *
     * @return self
     */
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling ConnectAsendiaRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setFtpUsername($ftp_username)
    {
        ...
        if ((mb_strlen($ftp_username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ftp_username when calling ConnectAsendiaRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setFtpPassword($ftp_password)
    {
        ...
        if ((mb_strlen($ftp_password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ftp_password when calling ConnectAsendiaRequestBody., must be bigger than or equal to 1.');
        }
