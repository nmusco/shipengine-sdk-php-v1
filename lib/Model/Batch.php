...
class Batch implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['batch_notes'] = isset($data['batch_notes']) ? $data['batch_notes'] : '';
        ...
        $this->container['batch_shipments_url'] = isset($data['batch_shipments_url']) ? $data['batch_shipments_url'] : null;
        $this->container['batch_labels_url'] = isset($data['batch_labels_url']) ? $data['batch_labels_url'] : null;
        $this->container['batch_errors_url'] = isset($data['batch_errors_url']) ? $data['batch_errors_url'] : null;
