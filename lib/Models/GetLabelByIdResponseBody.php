...
/**
 * GetLabelByIdResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class GetLabelByIdResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_label_by_id_response_body';
    ...
    public function setTrackingNumber($tracking_number)
    {
        ...
        if (!is_null($tracking_number) && (mb_strlen($tracking_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling GetLabelByIdResponseBody., must be bigger than or equal to 1.');
        }
