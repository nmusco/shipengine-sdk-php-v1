...
/**
 * ConnectAmazonBuyShippingRequestBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ConnectAmazonBuyShippingRequestBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_amazon_buy_shipping_request_body';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['merchant_seller_id'] = isset($data['merchant_seller_id']) ? $data['merchant_seller_id'] : null;
     ...
     * Sets nickname
     *
     * @param string $nickname Nickname to be associated with the account connection
     *
     * @return $this
     */
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ConnectAmazonBuyShippingRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantSellerId($merchant_seller_id)
    {
        ...
        if ((mb_strlen($merchant_seller_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $merchant_seller_id when calling ConnectAmazonBuyShippingRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setMwsAuthToken($mws_auth_token)
    {
        ...
        if ((mb_strlen($mws_auth_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mws_auth_token when calling ConnectAmazonBuyShippingRequestBody., must be bigger than or equal to 1.');
        }
