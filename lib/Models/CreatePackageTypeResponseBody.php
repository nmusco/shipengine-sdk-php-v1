...
/**
 * CreatePackageTypeResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePackageTypeResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_package_type_response_body';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreatePackageTypeResponseBody., must be bigger than or equal to 1.');
        }
