...
class Carrier implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['requires_funded_amount'] = isset($data['requires_funded_amount']) ? $data['requires_funded_amount'] : null;
        $this->container['balance'] = isset($data['balance']) ? $data['balance'] : null;
        $this->container['nickname'] = isset($data['nickname']) ? $data['nickname'] : null;
        $this->container['friendly_name'] = isset($data['friendly_name']) ? $data['friendly_name'] : null;
        $this->container['primary'] = isset($data['primary']) ? $data['primary'] : null;
        $this->container['has_multi_package_supporting_services'] = isset($data['has_multi_package_supporting_services']) ? $data['has_multi_package_supporting_services'] : null;
        $this->container['supports_label_messages'] = isset($data['supports_label_messages']) ? $data['supports_label_messages'] : null;
