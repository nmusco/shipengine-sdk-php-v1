...
/**
 * CreateWarehouseRequestBody Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateWarehouseRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_warehouse_request_body';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateWarehouseRequestBody., must be bigger than or equal to 1.');
        }
     ...
     * Sets origin_address
     *
     * @param Address $origin_address The origin address of the warehouse
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at Timestamp that indicates when the warehouse was created
     *
     * @return self
     */
     ...
     * Sets return_address
     *
     * @param Address|null $return_address The return address associated with the warehouse
     *
     * @return self
     */
