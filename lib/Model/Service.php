...
class Service implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'is_multi_package_supported' => 'setIsMultiPackageSupported'
    ];
    ...
    protected static $getters = [
        ...
        'is_multi_package_supported' => 'getIsMultiPackageSupported'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_multi_package_supported'] = isset($data['is_multi_package_supported']) ? $data['is_multi_package_supported'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['service_code']) && (mb_strlen($this->container['service_code']) < 1)) {
    ...
    public function setServiceCode($service_code)
    {
        ...
        if (!is_null($service_code) && (mb_strlen($service_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $service_code when calling Service., must be bigger than or equal to 1.');
        }
     ...
     * Sets name
     *
     * @param string|null $name User friendly service name
     *
     * @return $this
     */
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Service., must be bigger than or equal to 1.');
        }
     ...
     * Sets domestic
     *
     * @param bool|null $domestic Supports domestic shipping
     *
     * @return $this
     */
     ...
     * Sets international
     *
     * @param bool|null $international Supports international shipping.
     *
     * @return $this
     */
    ...
    /**
     * Gets is_multi_package_supported
     *
     * @return bool|null
     */
    public function getIsMultiPackageSupported()
    {
        return $this->container['is_multi_package_supported'];
    }

    /**
     * Sets is_multi_package_supported
     *
     * @param bool|null $is_multi_package_supported Carrier supports multiple packages per shipment
     *
     * @return $this
     */
    public function setIsMultiPackageSupported($is_multi_package_supported)
    {
        $this->container['is_multi_package_supported'] = $is_multi_package_supported;
