...
/**
 * ConnectSekoRequestBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ConnectSekoRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_seko_request_body';
    ...
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ConnectSekoRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setAccessKey($access_key)
    {
        ...
        if ((mb_strlen($access_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $access_key when calling ConnectSekoRequestBody., must be bigger than or equal to 1.');
        }
