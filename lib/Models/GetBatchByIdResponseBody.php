...
/**
 * GetBatchByIdResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class GetBatchByIdResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_batch_by_id_response_body';
    ...
    public function setBatchNumber($batch_number)
    {
        ...
        if ((mb_strlen($batch_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $batch_number when calling GetBatchByIdResponseBody., must be bigger than or equal to 0.');
        }
    ...
    public function setExternalBatchId($external_batch_id)
    {
        ...
        if ((mb_strlen($external_batch_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $external_batch_id when calling GetBatchByIdResponseBody., must be bigger than or equal to 0.');
        }
    ...
    public function setErrors($errors)
    {
        ...
        if (($errors < 0)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling GetBatchByIdResponseBody., must be bigger than or equal to 0.');
        }
    ...
    public function setWarnings($warnings)
    {
        ...
        if (($warnings < 0)) {
            throw new \InvalidArgumentException('invalid value for $warnings when calling GetBatchByIdResponseBody., must be bigger than or equal to 0.');
        }
    ...
    public function setCompleted($completed)
    {
        ...
        if (($completed < 0)) {
            throw new \InvalidArgumentException('invalid value for $completed when calling GetBatchByIdResponseBody., must be bigger than or equal to 0.');
        }
    ...
    public function setForms($forms)
    {
        ...
        if (($forms < 0)) {
            throw new \InvalidArgumentException('invalid value for $forms when calling GetBatchByIdResponseBody., must be bigger than or equal to 0.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling GetBatchByIdResponseBody., must be bigger than or equal to 0.');
        }
