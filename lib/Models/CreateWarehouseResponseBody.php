...
/**
 * CreateWarehouseResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateWarehouseResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_warehouse_response_body';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateWarehouseResponseBody., must be bigger than or equal to 1.');
        }
