...
/**
 * GetWarehouseByIdResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class GetWarehouseByIdResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_warehouse_by_id_response_body';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetWarehouseByIdResponseBody., must be bigger than or equal to 1.');
        }
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Timestamp that indicates when the warehouse was created
     *
     * @return self
     */
     ...
     * Sets return_address
     *
     * @param Address $return_address The return address associated with the warehouse
     *
     * @return self
     */
