...
/**
 * ConnectSendleRequestBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ConnectSendleRequestBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_sendle_request_body';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sendle_id'] = isset($data['sendle_id']) ? $data['sendle_id'] : null;
    ...
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ConnectSendleRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling ConnectSendleRequestBody., must be bigger than or equal to 1.');
        }
