...
class Link implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets href
     *
     * @param string $href The URL of the linked resource, if any
     *
     * @return self
     */
    ...
    public function setType($type)
    {
        ...
        if (!is_null($type) && (mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling Link., must be bigger than or equal to 1.');
        }
