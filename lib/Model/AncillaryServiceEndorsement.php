...
/**
 * AncillaryServiceEndorsement Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class AncillaryServiceEndorsement
{
    /**
     * Possible values of this enum
     */
    const NONE = 'none';
    const RETURN_SERVICE_REQUESTED = 'return_service_requested';
    const FORWARDING_SERVICE_REQUESTED = 'forwarding_service_requested';
    const ADDRESS_SERVICE_REQUESTED = 'address_service_requested';
    const CHANGE_SERVICE_REQUESTED = 'change_service_requested';
    const LEAVE_IF_NO_RESPONSE = 'leave_if_no_response';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::NONE,
            self::RETURN_SERVICE_REQUESTED,
            self::FORWARDING_SERVICE_REQUESTED,
            self::ADDRESS_SERVICE_REQUESTED,
            self::CHANGE_SERVICE_REQUESTED,
            self::LEAVE_IF_NO_RESPONSE,
        ];
    }
}
