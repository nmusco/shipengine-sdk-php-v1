...
/**
 * ConnectRrDonnelleyRequestBody Class Doc Comment
 *
 * @category Class
 ...
 */
class ConnectRrDonnelleyRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_rr_donnelley_request_body';
    ...
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ConnectRrDonnelleyRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling ConnectRrDonnelleyRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling ConnectRrDonnelleyRequestBody., must be bigger than or equal to 1.');
        }
