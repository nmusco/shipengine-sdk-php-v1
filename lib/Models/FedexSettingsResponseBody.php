...
/**
 * FedexSettingsResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class FedexSettingsResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'fedex_settings_response_body';
    ...
    public function setNickname($nickname)
    {
        ...
        if (!is_null($nickname) && (mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling FedexSettingsResponseBody., must be bigger than or equal to 1.');
        }
