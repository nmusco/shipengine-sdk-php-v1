...
/**
 * ConnectCanadaPostRequestBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ConnectCanadaPostRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_canada_post_request_body';
    ...
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ConnectCanadaPostRequestBody., must be bigger than or equal to 1.');
        }
     ...
     * Sets api_key
     *
     * @param string $api_key Canada Post Account API Key
     *
     * @return self
     */
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling ConnectCanadaPostRequestBody., must be bigger than or equal to 1.');
        }
     ...
     * Sets api_secret
     *
     * @param string $api_secret Canada Post Account API Secret
     *
     * @return self
     */
    public function setApiSecret($api_secret)
    {
        ...
        if ((mb_strlen($api_secret) < 1)) {
            throw new \InvalidArgumentException('invalid length for $api_secret when calling ConnectCanadaPostRequestBody., must be bigger than or equal to 1.');
        }
     ...
     * Sets account_number
     *
     * @param string $account_number Canada Post Account Number
     *
     * @return self
     */
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling ConnectCanadaPostRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setContractId($contract_id)
    {
        ...
        if ((mb_strlen($contract_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contract_id when calling ConnectCanadaPostRequestBody., must be bigger than or equal to 1.');
        }
