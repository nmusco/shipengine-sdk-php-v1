...
class ResponseMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'response_message';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['detail_code'] = $data['detail_code'] ?? null;
    }
     ...
     * Gets code
     *
     * @return AddressValidationCode|null
     */
     ...
     * Sets code
     *
     * @param AddressValidationCode|null $code code
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Message explaining the address validation error
     *
     * @return self
     */
    public function setMessage($message)
    {
        ...
        if (!is_null($message) && (mb_strlen($message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message when calling ResponseMessage., must be bigger than or equal to 1.');
        }
     ...
     * Gets type
     *
     * @return AddressValidationMessageType|null
     */
     ...
     * Sets type
     *
     * @param AddressValidationMessageType|null $type type
     *
     * @return self
     */
     ...
     * Gets detail_code
     *
     * @return AddressValidationDetailCode|null
     */
     ...
     * Sets detail_code
     *
     * @param AddressValidationDetailCode|null $detail_code detail_code
     *
     * @return self
     */
