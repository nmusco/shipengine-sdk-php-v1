...
/**
 * GetCarrierByIdResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class GetCarrierByIdResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_carrier_by_id_response_body';
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if (!is_null($account_number) && (mb_strlen($account_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling GetCarrierByIdResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setBalance($balance)
    {
        ...
        if (!is_null($balance) && ($balance < 0)) {
            throw new \InvalidArgumentException('invalid value for $balance when calling GetCarrierByIdResponseBody., must be bigger than or equal to 0.');
        }
    ...
    public function setNickname($nickname)
    {
        ...
        if (!is_null($nickname) && (mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling GetCarrierByIdResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setFriendlyName($friendly_name)
    {
        ...
        if (!is_null($friendly_name) && (mb_strlen($friendly_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $friendly_name when calling GetCarrierByIdResponseBody., must be bigger than or equal to 1.');
        }
