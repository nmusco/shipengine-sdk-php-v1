...
/**
 * ConnectDhlExpressAuRequestBody Class Doc Comment
 *
 * @category Class
 ...
 */
class ConnectDhlExpressAuRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_dhl_express_au_request_body';
    ...
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ConnectDhlExpressAuRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling ConnectDhlExpressAuRequestBody., must be bigger than or equal to 1.');
        }
