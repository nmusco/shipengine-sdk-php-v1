...
class WebhookEvent
{
     ...
     */
    const BATCH = 'batch';
    const CARRIER_CONNECTED = 'carrier_connected';
    const ORDER_SOURCE_REFRESH_COMPLETE = 'order_source_refresh_complete';
    const RATE = 'rate';
    const REPORT_COMPLETE = 'report_complete';
    const SALES_ORDERS_IMPORTED = 'sales_orders_imported';
    const TRACK = 'track';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::ORDER_SOURCE_REFRESH_COMPLETE,
            self::RATE,
            self::REPORT_COMPLETE,
            self::SALES_ORDERS_IMPORTED,
            self::TRACK,
        ];
    }
}
