...
/**
 * CreateShipmentsResponseBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class CreateShipmentsResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_shipments_response_body';
    ...
    {
        $this->container['has_errors'] = $data['has_errors'] ?? false;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['has_errors'] === null) {
            $invalidProperties[] = "'has_errors' can't be null";
        }
     ...
     * Sets has_errors
     *
     * @param bool $has_errors Indicates if errors occured while creating the shipments
     *
     * @return self
     */
     ...
     * Sets shipments
     *
     * @param CreateAndValidateShipment[] $shipments An array of shipments that were created.
     *
     * @return self
     */
