...
/**
 * GetWebhookByIdResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class GetWebhookByIdResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_webhook_by_id_response_body';
     ...
     * Sets webhook_id
     *
     * @param string $webhook_id A string that uniquely identifies the webhook
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url The url that the webhook sends the request to
     *
     * @return self
     */
