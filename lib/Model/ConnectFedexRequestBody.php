...
/**
 * ConnectFedexRequestBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ConnectFedexRequestBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'connect_fedex_request_body';
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling ConnectFedexRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress1($address1)
    {
        ...
        if ((mb_strlen($address1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling ConnectFedexRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress2($address2)
    {
        ...
        if (!is_null($address2) && (mb_strlen($address2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling ConnectFedexRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling ConnectFedexRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setCompany($company)
    {
        ...
        if (!is_null($company) && (mb_strlen($company) < 1)) {
            throw new \InvalidArgumentException('invalid length for $company when calling ConnectFedexRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling ConnectFedexRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling ConnectFedexRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling ConnectFedexRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling ConnectFedexRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling ConnectFedexRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state when calling ConnectFedexRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling ConnectFedexRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setMeterNumber($meter_number)
    {
        ...
        if (!is_null($meter_number) && (mb_strlen($meter_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $meter_number when calling ConnectFedexRequestBody., must be bigger than or equal to 1.');
        }
