...
/**
 * CreateLabelRequestBody Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateLabelRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_label_request_body';
     ...
     * Sets shipment
     *
     * @param Shipment $shipment The shipment information used to generate the label
     *
     * @return self
     */
    ...
    public function setTrackingNumber($tracking_number)
    {
        ...
        if (!is_null($tracking_number) && (mb_strlen($tracking_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling CreateLabelRequestBody., must be bigger than or equal to 1.');
        }
