...
/**
 * GetShipmentByExternalIdResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class GetShipmentByExternalIdResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_shipment_by_external_id_response_body';
     ...
     * Sets warehouse_id
     *
     * @param string $warehouse_id The [warehouse](https://www.shipengine.com/docs/shipping/ship-from-a-warehouse/) that the shipment is being shipped from.  Either `warehouse_id` or `ship_from` must be specified.
     *
     * @return self
     */
    ...
    public function setExternalShipmentId($external_shipment_id)
    {
        if (!is_null($external_shipment_id) && (mb_strlen($external_shipment_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $external_shipment_id when calling GetShipmentByExternalIdResponseBody., must be smaller than or equal to 50.');
        }
