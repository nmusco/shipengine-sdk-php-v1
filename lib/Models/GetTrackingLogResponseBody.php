...
/**
 * GetTrackingLogResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class GetTrackingLogResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_tracking_log_response_body';
    ...
    public function setStatusCode($status_code)
    {
        ...
        if ((mb_strlen($status_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status_code when calling GetTrackingLogResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setCarrierStatusCode($carrier_status_code)
    {
        ...
        if ((mb_strlen($carrier_status_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $carrier_status_code when calling GetTrackingLogResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setStatusDescription($status_description)
    {
        ...
        if (!is_null($status_description) && (mb_strlen($status_description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $status_description when calling GetTrackingLogResponseBody., must be bigger than or equal to 0.');
        }
    ...
    public function setCarrierStatusDescription($carrier_status_description)
    {
        ...
        if (!is_null($carrier_status_description) && (mb_strlen($carrier_status_description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $carrier_status_description when calling GetTrackingLogResponseBody., must be bigger than or equal to 0.');
        }
    ...
    public function setExceptionDescription($exception_description)
    {
        ...
        if (!is_null($exception_description) && (mb_strlen($exception_description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $exception_description when calling GetTrackingLogResponseBody., must be bigger than or equal to 0.');
        }
