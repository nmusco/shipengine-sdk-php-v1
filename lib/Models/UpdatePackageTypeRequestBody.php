...
/**
 * UpdatePackageTypeRequestBody Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdatePackageTypeRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_package_type_request_body';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdatePackageTypeRequestBody., must be bigger than or equal to 1.');
        }
