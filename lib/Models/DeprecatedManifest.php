...
/**
 * DeprecatedManifest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DeprecatedManifest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deprecated_manifest';
    ...
    public function setShipments($shipments)
    {
        ...
        if (!is_null($shipments) && ($shipments < 1)) {
            throw new \InvalidArgumentException('invalid value for $shipments when calling DeprecatedManifest., must be bigger than or equal to 1.');
        }
    ...
    public function setSubmissionId($submission_id)
    {
        ...
        if (!is_null($submission_id) && (mb_strlen($submission_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $submission_id when calling DeprecatedManifest., must be bigger than or equal to 1.');
        }
