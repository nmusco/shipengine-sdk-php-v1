...
/**
 * CreateReturnLabelResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateReturnLabelResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_return_label_response_body';
    ...
    public function setTrackingNumber($tracking_number)
    {
        ...
        if (!is_null($tracking_number) && (mb_strlen($tracking_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling CreateReturnLabelResponseBody., must be bigger than or equal to 1.');
        }
