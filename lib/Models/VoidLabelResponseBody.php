...
/**
 * VoidLabelResponseBody Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class VoidLabelResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'void_label_response_body';
     ...
     * Sets approved
     *
     * @param bool $approved Indicates whether the attempt to void the label was successful
     *
     * @return self
     */
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) < 0)) {
            throw new \InvalidArgumentException('invalid length for $message when calling VoidLabelResponseBody., must be bigger than or equal to 0.');
        }
